...
import shareImg from "../../../assets/illustration_share.jpg";
...
function CreateSuccess() {
  ...
  useShareAppMessage(() => {
    return {
      title: `${creatorName}邀请你加入${className}，一起多聚聚多聊聊~`,
  ...
  return (
    <View className="success_page">
      ...
      <Button
        ...
        onClick={() => {
          Taro.redirectTo({ url: `${CLASS_DETAIL}?_id=${classId}` });
        }}
      >
        查看班级
      </Button>
      <Button className="share_btn" hoverClass="btn_hover" openType="share">
        邀请同学
      </Button>
