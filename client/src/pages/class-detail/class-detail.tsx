...
function ClassDetail() {
  ...
  useShareAppMessage(() => {
    ...
    return {
      title: `${shareName}邀请你加入${classState.className}，查看同学的位置，多聊聊多聚聚~`,
  ...
  useShareTimeline(() => {
    ...
    return {
      title: `${shareName}邀请你加入${classState.className}，查看同学的位置~`,
      ...
      <View className="detail_container">
        ...
        <View className="class_info">
          ...
          <View className="info_item">
            已加入：{classState.joinUsers.length}人
          </View>
        </View>
        {loaded &&
