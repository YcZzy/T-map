    ...
    <View className="map_page">
      ...
      >
        <View className="search_container">
          <View className="search_opacity"></View>
          <Search
            autoFocus={false}
            hint={"输入同学姓名搜索"}
        ...
        <View className={`people_info ${callOutOpen}`}>
          <View className="info_avatar">
            ...
            <View className="time_info">{`(信息更新于 ${formatTime(
          ...
          <View className="info_detail">
            <View
              className="info_item"
              onClick={() => {
                Taro.setClipboardData({ data: currentUser.place });
              }}
            >
              <Image className="info_icon" src={iconCompass} />
              <View className="info_txt">
                去向：{WHEREOPTION[currentUser.state]} / {currentUser.place}
              </View>
            </View>
            {/**
            ...
            */}
            ...
            <View
              onClick={() => {
                Taro.setClipboardData({ data: currentUser.address });
              }}
              className="info_item"
            >
